...
> 本简报覆盖 2026-08-18 的 AI 行业动态，数据由 AIHOT 自动采集整理。
...
🔗 [原文链接](https://www.modular.com/blog/mojo-open-source)
...
🔗 [原文链接](https://x.com/claudeai/status/2089806039088517356)
...
### 6. Claude Science 产品指南：面向生命科学研究的 AI 工作台

Anthropic 发布 Claude Science（测试版），一个覆盖生命科学数字化流程的 AI 工作台，支持数据分析、图表生成与结果产出，并可通过本地守护进程将重任务调度至自有 GPU、SLURM 集群或云账户。

来源：Claude：Blog（网页）

🔗 [原文链接](https://claude.com/blog/the-claude-science-product-guide)

## 行业动态

### 7. OpenAI 启动新计划，强化国家安全领域 AI 的民主监督
...
🔗 [原文链接](https://openai.com/index/strengthening-democratic-oversight-in-national-security)

## 论文研究

### 8. Claude 如何加速蛋白质设计与分析化学研究
...
### 9. 智能体记忆并非越多越好：八款模型评测显示剂量需按能力校准
...
🔗 [原文链接](https://machinelearning.apple.com/research/mvicad2-delays-dilations)

## 技巧与观点

### 12. 设计 AI 评测：先求清晰，再谈可视化

本文演示如何用开源评测框架 Inspect AI 和 Harbor 评估 agent 技能，并借助 Google Sheets 和 Data Studio 进行可视化分析。

来源：Google AI：DEV 作者专属（RSS）

🔗 [原文链接](https://dev.to/googleai/designing-ai-evals-clarity-now-and-visualization-next-4eii)

### 13. OpenAI 在“关键网络能力”时代放缓模型开发节奏
...
### 14. Claude Tag 如何担任 Anthropic CI/CD 故障的一线响应者
...
### 15. 笔记本模型也能媲美云端前沿模型：Qwen3.8-27B 登顶智能指数

作者将 Qwen3.8-27B 装入智能体后表现优异，该模型在 Artificial Analysis 智能指数中排名 135 款模型之首，得分 52，超过 Z.ai 的 753B 参数开源模型 GLM-5.2（51 分）。

来源：Tomer Tunguz 博客（VC 分析）

🔗 [原文链接](https://www.tomtunguz.com/birds-dont-fly-like-planes-neither-does-ai)

### 16. Populous 如何用 Runway 呈现全球标志性场馆设计
...
🔗 [原文链接](https://runwayml.com/news/customers/populous)
