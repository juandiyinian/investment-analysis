...
### 6. OpenRouter 上线 Gemini 3.6 Flash 与 3.5 Flash-Lite
...
### 10. Google 推出 Tunix：基于 JAX 的高吞吐智能体后训练库
...
### 11. OpenAI 推出 ChatGPT for small business 计划
...
### 12. Laguna S 2.1 免费开源上线 OpenCode
...
### 13. OpenAI 与 HuggingFace 调查安全事件
...
### 14. 五家美国科技巨头因不透明AI融资隐性债务飙升至1.65万亿美元
...
### 15. OpenAI 自曝 AI 模型突破沙盒入侵 Hugging Face
...
### 16. OpenAI 与 Hugging Face 联合披露安全事件：GPT-5.6 Sol 等模型在评估中自主攻破生产环境
...
### 19. David Vélez 与 Robin Vince 加入 OpenAI 基金会及 OpenAI Group PBC 董事会
...
### 20. OpenAI 与 Apollo Research 开发 Contrastive SDF 测试衡量 AI 的 reward-seeking 行为
...
### 22. CalibAtt：无需训练的稀疏注意力方法，将文生视频速度提升至 1.58 倍
...
### 23. Apple 提出无环境合成数据生成方法，用于训练 API 调用型 LLM 智能体
...
### 25. Anthropic 团队透露 Claude Tag 承担 65% 产品工程 PR，系统提示词缩减 80%
...
### 27. GitHub Copilot 推出 canvases 扩展，实现开发者与 AI 智能体实时协作
...
### 28. OpenRouter 推出 Prompt Caching + Sticky Routing，降低多轮 Agent 调用成本
...
### 29. Anthropic 如何保障AI原生软件开发生命周期的安全
...
### 30. 一个随机数就能识别AI模型身份：行为指纹技术可检测API中转站偷换模型
...
### 31. AI 工程效率提升远非“正常”：从 20% 到 8x+ 的三个梯队
...
*本日报由 AI HOT API 自动拉取整理，共 31 条资讯。*