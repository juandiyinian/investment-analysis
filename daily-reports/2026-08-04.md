...
**来源**: NVIDIA Blog（RSS）
**原文**: https://blogs.nvidia.com/blog/alpamayo-2-super-open-model-now-available
...
**原文**: https://x.com/SenseTime_AI/status/2084667189479837741
...
**原文**: https://x.com/OpenRouter/status/2084699413898027064

### 4. 蚂蚁百灵发布Ling-3.0-flash开源权重

今天，我们发布了 Ling-3.0-flash 的开源权重。🎉 官方 BF16 和 FP8 量化版本现已可用，您可以根据自己的硬件、性能要求和部署需求选择最合适的版本。

**来源**: X：蚂蚁百灵 (@AntLingAGI)
**原文**: https://x.com/AntLingAGI/status/2084656533489754475
...
**来源**: 公众号：腾讯混元
**原文**: https://mp.weixin.qq.com/s?__biz=MzkwODU2OTQyNQ%3D%3D&mid=2247498223&idx=1&sn=ae271ec2c72723393d3e1d8074a33205

### 6. FLUX 3 Video, Part 1: Generation FLUX 3 Video, Part 1 August 4, 2026 Read more

**来源**: Black Forest Labs：Blog（网页）
**原文**: https://bfl.ai/blog/flux-3-video

## 产品发布/更新

### 7. Swiftlet：在 Mac 上运行 80B 版 Qwen（内存 4.3 GB），在 iPhone 上运行 35B 版
...
### 8. Reflex 开源 XY：基于 Rust 的超快 Python 绘图库，可保持 1 亿点图表交互流畅

Reflex AI 发布 Apache-2.0 许可的 Python 交互式 2D 绘图库 XY，通过 Rust 原生核心、二进制缓冲传输和 WebGL2 渲染，在 1 万至 1 亿点范围内保持约 0.08 秒的渲染时间。

**来源**: MarkTechPost（RSS）
**原文**: https://www.marktechpost.com/2026/08/04/reflex-open-sources-xy-a-rust-backed-super-fast-python-charting-library-that-keeps-100-million-point-charts-interactive

### 9. 面壁智能开源 ForgeStencil：一周自动优化 100+ 工业与科学软件，全程零人工介入

面壁智能联合 OpenBMB 开源全球首个支持 Stencil 自动研究、自动部署的 AI 优化系统 ForgeStencil，由 Kernel Agent 与 App Agent 闭环协作，实现从算子优化到应用集成的全自动流程。

**来源**: 公众号：面壁智能（MiniCPM）
**原文**: https://mp.weixin.qq.com/s?__biz=Mzg3Mzg2MTg2NQ%3D%3D&mid=2247498861&idx=1&sn=d2d16692dd7eb27f9d466803f25c2b78

### 10. Soup v0.72.4：在4 GB显存笔记本GPU上微调8B模型

Soup 推出 v0.72.4，支持在配备 4 GB 显存的笔记本 GPU 上通过 QLoRA 微调 8B 模型，无需 SSH 或云服务。

**来源**: Hacker News 热门（buzzing.cc 中文翻译）
**原文**: https://github.com/MakazhanAlpamys/Soup

### 11. OpenRouter 推出 ori CLI：为 Claude Code 等 Harness 提供开箱即用的优化配置

OpenRouter 发布 ori CLI，用户安装并登录后即可获得针对 Claude Code、Codex、OpenCode、Hermes 等 harness 的优化配置，省去手动设置大量环境变量的麻烦。

**来源**: OpenRouter：Announcements（RSS）
**原文**: https://openrouter.ai/blog/announcements/ori-harness

### 12. SpecForge v0.3.0 发布：统一解耦与共置投机解码栈，新增开放 SpecBundle 草稿模型
...
**来源**: X：Replit (@Replit)
**原文**: https://x.com/Replit/status/2084761337570144424

### 14. Cloudflare 让智能体通过本地追踪调试 Workers
...
### 15. Anthropic 与成立仅数月的云初创公司 Volta 签署 100 亿美元算力协议
...
**原文**: https://x.com/rohanpaul_ai/status/2084655258102546579

### 16. 工信部发布首部L3/L4自动驾驶系统安全要求强制性国标，2027年7月实施
...
**来源**: IT之家（RSS）
**原文**: https://www.ithome.com/0/985/665.htm

### 17. GPT-5.6 Luna降价80%永久生效
...
### 18. Mariano-Florentino (Tino) Cuéllar 加入 Anthropic 出任首席全球事务官
...
### 19. OpenAI 说明第三方网络安全评估事件并公布新保障措施
...
### 20. AI 领袖提出 SAFE 指南，强化智能体网络安全透明度

Linux 基金会发布共享 AI 事件交换（SAFE）指南征求意见稿，旨在将智能体网络安全事件转化为全生态共享防护。

**来源**: NVIDIA Blog（RSS）
**原文**: https://blogs.nvidia.com/blog/open-secure-ai-alliance-contributions

### 21. Google 发布 Gemini 3.6 Flash 等三款新模型及 Gemini Robotics ER 2
...
**原文**: https://blog.google/innovation-and-ai/technology/ai/google-ai-updates-july-2026

## 技巧与观点

### 22. 在单颗 AMD MI300X 上运行 DeepSeek V4 Flash
...
### 23. MiniMax-H3 通过 MLX 移植可在 Apple Silicon 上运行
...
**原文**: https://simonwillison.net/2026/Aug/4/minimax-h3-mlx

### 24. 用 NVIDIA SkillSpector、LangGraph、YARA 规则、SARIF 与 CI 策略门构建高级 AI 技能安全审计流水线

本教程演示如何用 NVIDIA SkillSpector 评估 AI 技能的安全态势，构建包含干净、风险、恶意及 MCP 示例的合成技能市场，并通过 LangGraph 检查流水线扫描每个技能。

**来源**: MarkTechPost（RSS）
**原文**: https://www.marktechpost.com/2026/08/04/building-an-advanced-ai-skill-security-auditing-pipeline-with-nvidia-skillspector-langgraph-yara-rules-sarif-and-ci-policy-gates

### 25. Cloudflare 如何用软件工厂将 Astro 的 GitHub issue 数降至零
...
### 26. GitHub 如何用堆叠式 Pull Request 拆解 AI 生成的巨型代码
...
**原文**: https://www.langchain.com/blog/how-to-evaluate-voice-agents-execution-outcomes-and-experience

### 28. 从零开始，教你用Codex搓出属于你自己的第一个硬件
...
**来源**: 公众号：数字生命卡兹克
**原文**: https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647684924&idx=1&sn=f9ecf13ac374f13dfa75f98f685a231d

### 29. 杰文斯悖论还能持续吗：AI 定价分层如何支撑算力需求增长
